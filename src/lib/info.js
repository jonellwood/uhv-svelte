...
// landing page, footer, and maybe in an email export function later...🤔
...
As such, my research lead me land upon, not a diet, but more a set of guideline for eating called "The Blue Zones" (<- make that a link). I am starting the blog around the same time I am changing the way I eat and think about food with the hopes of documenting it - the good and the bad - and making it available to anyone else who might find value in it. 
